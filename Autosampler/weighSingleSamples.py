...
try:
    standard_balance = serial.Serial(port=ComPorts.SampleBalance, baudrate=9600, bytesize=8, parity='N',stopbits=1,timeout=1, xonxoff=0)
except:
      ...
      if weight is FALSE:
         ...
         if (STOPPED.get() <1 ):
            ...
            if count <5:
               ...
               statustext = "Count: %d the average weight of sample is: %f with stdev of: %f" % (count, averageWeight, stdevWeight)
            STATUS.set(statustext)
