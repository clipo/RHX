...
def gotoSamplePosition(position):
   ...
   try:
      ...
      while stepper.getCurrentPosition(0) !=(MOVE[position][X]):
         pass
      sleep(2)
...
def samplePutDown():
   ...
   try:
      ...
      sleep(2)
      openGripper()
      advancedServo.setPosition(ZMOTOR, advancedServo.getPositionMin(0))
      while advancedServo.getPosition(ZMOTOR) != advancedServo.getPositionMin(0):
        pass
      sleep(2)
   except PhidgetException as e:
      print("Phidget Exception %i: %s" % (e.code, e.details))
...
def gotoOutsideBalanceFromInside():
   ...
   try:
      stepper.setTargetPosition(0, BALANCE_OUTSIDE[0])
      while stepper.getCurrentPosition(0) !=BALANCE_OUTSIDE[0]:
         pass
   except PhidgetException as e:
      print("Phidget Exception %i: %s" % (e.code, e.details))
      print("Exiting....")
...
def gotoOutsideBalanceFromOutside():
   ...
   try:
      stepper.setTargetPosition(2, BALANCE_OUTSIDE[1])
      while stepper.getCurrentPosition(2) != BALANCE_OUTSIDE[1]:
         pass
   except PhidgetException as e:
      print("Phidget Exception %i: %s" % (e.code, e.details))
      print("Exiting....")
...
def gotoInsideBalanceFromOutside():
   ...
   try:
      stepper.setTargetPosition(2, BALANCE_INSIDE[1])
      while stepper.getCurrentPosition(2) !=BALANCE_INSIDE[1]:
         pass
   except PhidgetException as e:
      print("Phidget Exception %i: %s" % (e.code, e.details))
      print("Exiting....")
   ...
   #set x axis -- move it to point outside...
   try:
      stepper.setTargetPosition(0, BALANCE_INSIDE[0])
      while stepper.getCurrentPosition(0) !=BALANCE_INSIDE[0]:
         pass
   except PhidgetException as e:
      print("Phidget Exception %i: %s" % (e.code, e.details))
      print("Exiting....")
...
def pickUpSampleFromBalance(): 
   ...
   try:
      stepper.setTargetPosition(2, BALANCE_INSIDE_POSITION[1])
      while stepper.getCurrentPosition(2) !=BALANCE_INSIDE_POSITION[1]:
         pass
   except PhidgetException as e:
        print("Phidget Exception %i: %s" % (e.code, e.details))
        print("Exiting....")
   ...
   try:
      stepper.setTargetPosition(2, BALANCE_INSIDE_POSITION[X])
      while stepper.getCurrentPosition(2) !=BALANCE_INSIDE_POSITION[X]:
         pass
   except PhidgetException as e:
        print("Phidget Exception %i: %s" % (e.code, e.details))
        print("Exiting....")
   ...
   try:
      stepper.setTargetPosition(0, BALANCE_OUTSIDE_POSITION[X])
      while stepper.getCurrentPosition(0) !=BALANCE_OUTSIDE_POSITION[X]:
         pass
   except PhidgetException as e:
        print("Phidget Exception %i: %s" % (e.code, e.details))
        print("Exiting....")
...
###Open Phidgets
print("Opening phidget object for servo ....")
...
print("Waiting for Arm (servo) to attach....")
...
print("Opening phidget object for stepper ....")    
try:
    stepper.openPhidget()
except PhidgetException as e:
    print("Phidget Exception %i: %s" % (e.code, e.details))
...
print ("Set positions for the stepper motors")
try:
