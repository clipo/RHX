...
int IniAllProcDefs()
{
    ...
    MSL_IniProcDef( &C01_Warn_User_to_Clear_Deck, "Warn User to Setup Crucibles", 3, 0, NULL, sizeof(MP2_PROC_CONTEXT_DEF) );
    MSL_IniProcDef( &C02_Test_Setup, "Test Setup", 5, 0, NULL, sizeof(MP2_PROC_CONTEXT_DEF) );
    MSL_IniProcDef( &C03_Random_Move_Loop, "XYZ Move Loop", 7, 0, NULL, sizeof(MP2_PROC_CONTEXT_DEF) );
...
int P00_Initial_User_Query()
{
    ...
    MSL_CreateEditBox( nDlg, 4, -175, 3, 15, 1, "Number of cycles to make", "Number of movement cycles to make", &Rt_nExecProc_S1, "INT", 1., 2000000000., 0., 0,  0x60 );
